  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-1 flex-col gap-8 p-6 sm:p-10">
      ...
      <section className="flex flex-wrap gap-3">
        ...
        <Link
          href={`/employment-income?year=${year}`}
          className="rounded-md border border-neutral-300 px-4 py-2 text-sm font-medium hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-900"
        >
          給与所得を試算する
        </Link>
        ...
        <Link
          href={`/earthquake-renovation-deduction?year=${year}`}
          className="rounded-md border border-neutral-300 px-4 py-2 text-sm font-medium hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-900"
        >
          住宅耐震改修特別控除額を試算する
        </Link>
        <Link
          href={`/energy-saving-renovation-deduction?year=${year}`}
          className="rounded-md border border-neutral-300 px-4 py-2 text-sm font-medium hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-900"
        >
          省エネ改修工事の住宅特定改修特別税額控除額を試算する
        </Link>
        <Link
          href={`/barrier-free-renovation-deduction?year=${year}`}
          className="rounded-md border border-neutral-300 px-4 py-2 text-sm font-medium hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-900"
        >
          バリアフリー改修工事の住宅特定改修特別税額控除額を試算する
        </Link>
        <Link
          href={`/multi-household-renovation-deduction?year=${year}`}
          className="rounded-md border border-neutral-300 px-4 py-2 text-sm font-medium hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-900"
        >
        ...
        <Link
          href={`/child-rearing-renovation-deduction?year=${year}`}
          className="rounded-md border border-neutral-300 px-4 py-2 text-sm font-medium hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-900"
        >
        ...
        <Link
          href={`/resident-tax-non-taxable?year=${year}`}
          className="rounded-md border border-neutral-300 px-4 py-2 text-sm font-medium hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-900"
        >
          住民税の非課税判定をする
        </Link>
        <Link
          href="/public-pension-income"
          className="rounded-md border border-neutral-300 px-4 py-2 text-sm font-medium hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-900"
        >
          公的年金等に係る雑所得を試算する
        </Link>
        ...
        <Link
          href="/vacant-house-sale-deduction"
          className="rounded-md border border-neutral-300 px-4 py-2 text-sm font-medium hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-900"
        >
          被相続人の居住用財産(空き家)を譲渡した場合の税額を試算する
        </Link>
        <Link
          href="/expropriation-sale-deduction"
          className="rounded-md border border-neutral-300 px-4 py-2 text-sm font-medium hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-900"
        >
          収用等により土地建物を売った場合の税額を試算する
        </Link>
        <Link
          href="/expropriation-replacement-deferral"
          className="rounded-md border border-neutral-300 px-4 py-2 text-sm font-medium hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-900"
        >
          収用等に伴い代替資産を取得した場合の課税繰延べを試算する
        </Link>
        <Link
          href="/land-readjustment-sale-deduction"
          className="rounded-md border border-neutral-300 px-4 py-2 text-sm font-medium hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-900"
        >
        ...
        <Link
          href="/land-acquired-2009-2010-sale-deduction"
          className="rounded-md border border-neutral-300 px-4 py-2 text-sm font-medium hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-900"
        >
        ...
        <Link
          href="/home-replacement-loss-deduction"
          className="rounded-md border border-neutral-300 px-4 py-2 text-sm font-medium hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-900"
        >
        ...
        <Link
          href="/stock-option-tax"
          className="rounded-md border border-neutral-300 px-4 py-2 text-sm font-medium hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-900"
        >
          ストックオプションの税額を試算する
        </Link>
        <Link
          href="/nft-creator-income"
          className="rounded-md border border-neutral-300 px-4 py-2 text-sm font-medium hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-900"
        >
          NFT一次流通の雑所得を試算する
        </Link>
