...
import { simulateLandReadjustmentSaleDeduction } from "@/lib/realEstate/landReadjustmentSaleDeduction";
...
export function LandReadjustmentSaleDeductionForm() {
  ...
  const result = useMemo(() => {
    try {
      return simulateLandReadjustmentSaleDeduction({
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        <label className="flex items-center gap-2 text-sm">
          ...
          (事業主体・買取りの種類、同一事業の買取りが2年以上にわたる場合は
          最初の年の買取りであること等)を満たす
        </label>
        <label className="flex items-center gap-2 text-sm">
          <input
      ...
      {result === null ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            ...
            <SummaryCard label="2,000万円特別控除の適用額" value={result.specialDeductionAppliedJpy} />
