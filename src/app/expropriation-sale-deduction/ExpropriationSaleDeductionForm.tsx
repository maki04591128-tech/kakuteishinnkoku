...
import { simulateExpropriationSaleTax } from "@/lib/realEstate/expropriationSaleTaxSimulation";
...
export function ExpropriationSaleDeductionForm() {
  ...
  const result = useMemo(() => {
    try {
      return simulateExpropriationSaleTax({
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        <label className="flex items-center gap-2 text-sm">
          ...
          課税繰延べの特例との選択適用、6か月以内の譲渡、最初に買取り等の
          申し出を受けた者本人による譲渡等)を満たす
        </label>
        <label className="flex items-center gap-2 text-sm">
          <input
            type="checkbox"
      ...
      {result === null ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            ...
            <SummaryCard label="5,000万円特別控除の適用額" value={result.specialDeductionAppliedJpy} />
