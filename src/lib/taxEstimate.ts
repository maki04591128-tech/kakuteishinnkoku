 ...
 * バリアフリー改修工事の住宅特定改修特別税額控除(`barrierFreeRenovationDeduction.ts`)・
 * 多世帯同居改修工事の住宅特定改修特別税額控除(`multiHouseholdRenovationDeduction.ts`)・
 * 耐久性向上改修工事の住宅特定改修特別税額控除(`durabilityImprovementRenovationDeduction.ts`)・
 * 子育て対応改修工事の住宅特定改修特別税額控除(`childRearingRenovationDeduction.ts`)・
 * 認定住宅等新築等特別税額控除(`certifiedHousingConstructionCredit.ts`)・
 ...
 * `/energy-saving-renovation-deduction`・`/barrier-free-renovation-deduction`・
 * `/multi-household-renovation-deduction`・`/durability-improvement-renovation-deduction`・
 * `/child-rearing-renovation-deduction`・`/certified-housing-construction-credit`・
 ...
 * 特別控除→省エネ改修工事の住宅特定改修特別税額控除→バリアフリー改修工事の住宅
 * 特定改修特別税額控除→多世帯同居改修工事の住宅特定改修特別税額控除→耐久性向上改修
 * 工事の住宅特定改修特別税額控除→子育て対応改修工事の住宅特定改修特別税額控除→
 * 認定住宅等新築等特別税額控除→外国税額控除の順に適用する(調整控除は住民税
 * 所得割のみが対象)。
 * 寄附金特別控除は
 ...
 * 特定改修特別税額控除(`energySavingRenovationDeductionJpy`)・バリアフリー改修工事の
 * 住宅特定改修特別税額控除(`barrierFreeRenovationDeductionJpy`)・多世帯同居改修工事の
 * 住宅特定改修特別税額控除(`multiHouseholdRenovationDeductionJpy`)・耐久性向上改修工事の
 * 住宅特定改修特別税額控除(`durabilityImprovementRenovationDeductionJpy`)・子育て対応改修
 * 工事の住宅特定改修特別税額控除(`childRearingRenovationDeductionJpy`)・認定住宅等
 * 新築等特別税額控除(`certifiedHousingConstructionCreditJpy`)はいずれも住民税に
 * 相当する控除が無い所得税のみの制度のため、寄附金特別控除適用後(省エネ改修工事分は
 * 住宅耐震改修特別控除適用後、バリアフリー改修工事分は省エネ改修工事分適用後、
 * 多世帯同居改修工事分はバリアフリー改修工事分適用後、耐久性向上改修工事分は
 * 多世帯同居改修工事分適用後、子育て対応改修工事分は耐久性向上改修工事分適用後、
 * 認定住宅等新築等特別税額控除分は子育て対応改修工事分適用後)の所得税額からのみ
 * 差し引く。
...
export interface TotalTaxEstimateInput {
  ...
  /**
   * バリアフリー改修工事の住宅特定改修特別税額控除(税額控除)額。省エネ改修工事の
   * 住宅特定改修特別税額控除と同様、住民税に相当する控除が無い所得税のみの制度の
   * ため、省エネ改修工事の住宅特定改修特別税額控除適用後の所得税額からのみ控除する。
   * `/barrier-free-renovation-deduction`の試算結果(または登録済みの値)をそのまま
   * 「その年に適用される控除額」として受け取る
   */
  barrierFreeRenovationDeductionJpy?: Decimal.Value;
  /**
   * 多世帯同居改修工事の住宅特定改修特別税額控除(税額控除)額。バリアフリー改修工事の
   * 住宅特定改修特別税額控除と同様、住民税に相当する控除が無い所得税のみの制度の
   * ため、バリアフリー改修工事の住宅特定改修特別税額控除適用後の所得税額からのみ
   * 控除する。`/multi-household-renovation-deduction`の試算結果(または登録済みの値)を
   * そのまま「その年に適用される控除額」として受け取る
   */
  multiHouseholdRenovationDeductionJpy?: Decimal.Value;
  /**
   * 耐久性向上改修工事の住宅特定改修特別税額控除(税額控除)額。多世帯同居改修工事の
   * 住宅特定改修特別税額控除と同様、住民税に相当する控除が無い所得税のみの制度の
   * ため、多世帯同居改修工事の住宅特定改修特別税額控除適用後の所得税額からのみ
   * 控除する。`/durability-improvement-renovation-deduction`の試算結果(または登録済みの値)を
   * そのまま「その年に適用される控除額」として受け取る
   */
  durabilityImprovementRenovationDeductionJpy?: Decimal.Value;
  /**
   * 子育て対応改修工事の住宅特定改修特別税額控除(税額控除)額。耐久性向上改修工事の
   * 住宅特定改修特別税額控除と同様、住民税に相当する控除が無い所得税のみの制度の
   * ため、耐久性向上改修工事の住宅特定改修特別税額控除適用後の所得税額からのみ
   * 控除する。`/child-rearing-renovation-deduction`の試算結果(または登録済みの値)を
   * そのまま「その年に適用される控除額」として受け取る
   */
  childRearingRenovationDeductionJpy?: Decimal.Value;
  /**
   * 認定住宅等新築等特別税額控除(税額控除)額。子育て対応改修工事の住宅特定改修
   * 特別税額控除と同様、住民税に相当する控除が無い所得税のみの制度のため、
   * 子育て対応改修工事の住宅特定改修特別税額控除適用後の所得税額からのみ控除する。
   * `/certified-housing-construction-credit`の試算結果(または登録済みの値)を
   * そのまま「その年に適用される控除額」として受け取る
   */
  certifiedHousingConstructionCreditJpy?: Decimal.Value;
...
export interface TotalTaxEstimateResult {
  ...
  /** 省エネ改修工事の住宅特定改修特別税額控除適用後・バリアフリー改修工事の住宅特定改修特別税額控除適用前の所得税額(復興特別所得税を含む) */
  totalNationalTaxAfterEnergySavingRenovationDeductionJpy: Decimal;
  /**
   * 実際に適用されたバリアフリー改修工事の住宅特定改修特別税額控除額(所得税分のみ。
   * 入力値と省エネ改修工事の住宅特定改修特別税額控除適用後の所得税額のいずれか少ない方。
   * 住民税に相当する控除は無い)
   */
  barrierFreeRenovationDeductionAppliedJpy: Decimal;
  /** バリアフリー改修工事の住宅特定改修特別税額控除適用後・多世帯同居改修工事の住宅特定改修特別税額控除適用前の所得税額(復興特別所得税を含む) */
  totalNationalTaxAfterBarrierFreeRenovationDeductionJpy: Decimal;
  /**
   * 実際に適用された多世帯同居改修工事の住宅特定改修特別税額控除額(所得税分のみ。
   * 入力値とバリアフリー改修工事の住宅特定改修特別税額控除適用後の所得税額のいずれか少ない方。
   * 住民税に相当する控除は無い)
   */
  multiHouseholdRenovationDeductionAppliedJpy: Decimal;
  /** 多世帯同居改修工事の住宅特定改修特別税額控除適用後・耐久性向上改修工事の住宅特定改修特別税額控除適用前の所得税額(復興特別所得税を含む) */
  totalNationalTaxAfterMultiHouseholdRenovationDeductionJpy: Decimal;
  /**
   * 実際に適用された耐久性向上改修工事の住宅特定改修特別税額控除額(所得税分のみ。
   * 入力値と多世帯同居改修工事の住宅特定改修特別税額控除適用後の所得税額のいずれか少ない方。
   * 住民税に相当する控除は無い)
   */
  durabilityImprovementRenovationDeductionAppliedJpy: Decimal;
  /** 耐久性向上改修工事の住宅特定改修特別税額控除適用後・子育て対応改修工事の住宅特定改修特別税額控除適用前の所得税額(復興特別所得税を含む) */
  totalNationalTaxAfterDurabilityImprovementRenovationDeductionJpy: Decimal;
  /**
   * 実際に適用された子育て対応改修工事の住宅特定改修特別税額控除額(所得税分のみ。
   * 入力値と耐久性向上改修工事の住宅特定改修特別税額控除適用後の所得税額のいずれか少ない方。
   * 住民税に相当する控除は無い)
   */
  childRearingRenovationDeductionAppliedJpy: Decimal;
  /** 子育て対応改修工事の住宅特定改修特別税額控除適用後・認定住宅等新築等特別税額控除適用前の所得税額(復興特別所得税を含む) */
  totalNationalTaxAfterChildRearingRenovationDeductionJpy: Decimal;
  /**
   * 実際に適用された認定住宅等新築等特別税額控除額(所得税分のみ。入力値と
   * 子育て対応改修工事の住宅特定改修特別税額控除適用後の所得税額のいずれか少ない方。
   * 住民税に相当する控除は無い)
   */
  certifiedHousingConstructionCreditAppliedJpy: Decimal;
  /** 認定住宅等新築等特別税額控除適用後・外国税額控除適用前の所得税額(復興特別所得税を含む) */
  totalNationalTaxAfterCertifiedHousingConstructionCreditJpy: Decimal;
  /** 実際に適用された外国税額控除額(所得税・復興特別所得税分。入力値と認定住宅等新築等特別税額控除適用後の所得税額のいずれか少ない方) */
...
export function estimateTotalTax(input: TotalTaxEstimateInput): TotalTaxEstimateResult {
  ...
  const barrierFreeRenovationDeductionJpy = input.barrierFreeRenovationDeductionJpy
    ? new Decimal(input.barrierFreeRenovationDeductionJpy)
    : new Decimal(0);
  requireNonNegative(barrierFreeRenovationDeductionJpy, "バリアフリー改修工事の住宅特定改修特別税額控除額");
  const barrierFreeRenovationDeductionAppliedJpy = Decimal.min(
    barrierFreeRenovationDeductionJpy,
    totalNationalTaxAfterEnergySavingRenovationDeductionJpy,
  );
  const totalNationalTaxAfterBarrierFreeRenovationDeductionJpy =
    totalNationalTaxAfterEnergySavingRenovationDeductionJpy.minus(
      barrierFreeRenovationDeductionAppliedJpy,
    );

  const multiHouseholdRenovationDeductionJpy = input.multiHouseholdRenovationDeductionJpy
    ? new Decimal(input.multiHouseholdRenovationDeductionJpy)
    : new Decimal(0);
  requireNonNegative(multiHouseholdRenovationDeductionJpy, "多世帯同居改修工事の住宅特定改修特別税額控除額");
  const multiHouseholdRenovationDeductionAppliedJpy = Decimal.min(
    multiHouseholdRenovationDeductionJpy,
    totalNationalTaxAfterBarrierFreeRenovationDeductionJpy,
  );
  const totalNationalTaxAfterMultiHouseholdRenovationDeductionJpy =
    totalNationalTaxAfterBarrierFreeRenovationDeductionJpy.minus(
      multiHouseholdRenovationDeductionAppliedJpy,
    );

  const durabilityImprovementRenovationDeductionJpy = input.durabilityImprovementRenovationDeductionJpy
    ? new Decimal(input.durabilityImprovementRenovationDeductionJpy)
    : new Decimal(0);
  requireNonNegative(
    durabilityImprovementRenovationDeductionJpy,
    "耐久性向上改修工事の住宅特定改修特別税額控除額",
  );
  const durabilityImprovementRenovationDeductionAppliedJpy = Decimal.min(
    durabilityImprovementRenovationDeductionJpy,
    totalNationalTaxAfterMultiHouseholdRenovationDeductionJpy,
  );
  const totalNationalTaxAfterDurabilityImprovementRenovationDeductionJpy =
    totalNationalTaxAfterMultiHouseholdRenovationDeductionJpy.minus(
      durabilityImprovementRenovationDeductionAppliedJpy,
    );

  const childRearingRenovationDeductionJpy = input.childRearingRenovationDeductionJpy
    ? new Decimal(input.childRearingRenovationDeductionJpy)
    : new Decimal(0);
  requireNonNegative(
    childRearingRenovationDeductionJpy,
    "子育て対応改修工事の住宅特定改修特別税額控除額",
  );
  const childRearingRenovationDeductionAppliedJpy = Decimal.min(
    childRearingRenovationDeductionJpy,
    totalNationalTaxAfterDurabilityImprovementRenovationDeductionJpy,
  );
  const totalNationalTaxAfterChildRearingRenovationDeductionJpy =
    totalNationalTaxAfterDurabilityImprovementRenovationDeductionJpy.minus(
      childRearingRenovationDeductionAppliedJpy,
    );

  const certifiedHousingConstructionCreditJpy = input.certifiedHousingConstructionCreditJpy
    ? new Decimal(input.certifiedHousingConstructionCreditJpy)
    : new Decimal(0);
  requireNonNegative(certifiedHousingConstructionCreditJpy, "認定住宅等新築等特別税額控除額");
  const certifiedHousingConstructionCreditAppliedJpy = Decimal.min(
    certifiedHousingConstructionCreditJpy,
    totalNationalTaxAfterChildRearingRenovationDeductionJpy,
  );
  const totalNationalTaxAfterCertifiedHousingConstructionCreditJpy =
    totalNationalTaxAfterChildRearingRenovationDeductionJpy.minus(
      certifiedHousingConstructionCreditAppliedJpy,
    );
  ...
  const foreignTaxCreditNationalTaxAppliedJpy = Decimal.min(
    ...
    totalNationalTaxAfterCertifiedHousingConstructionCreditJpy,
  );
  ...
  const totalNationalTaxAfterForeignTaxCreditJpy =
    totalNationalTaxAfterCertifiedHousingConstructionCreditJpy.minus(foreignTaxCreditNationalTaxAppliedJpy);
  ...
  if (multiHouseholdRenovationDeductionJpy.greaterThan(0)) {
    notes.push(
      "多世帯同居改修工事の住宅特定改修特別税額控除(税額控除)はバリアフリー改修工事の住宅特定改修特別税額控除適用後の所得税額からのみ差し引く(住民税に相当する控除は無い)。`/multi-household-renovation-deduction`の試算結果を前提とする。",
    );
    if (multiHouseholdRenovationDeductionAppliedJpy.lessThan(multiHouseholdRenovationDeductionJpy)) {
      notes.push(
        "多世帯同居改修工事の住宅特定改修特別税額控除額が控除適用後の所得税額を上回ったため、超過分は切り捨てて0円を下限とした(繰越・還付は生じない)。",
      );
    }
  }
  if (durabilityImprovementRenovationDeductionJpy.greaterThan(0)) {
    notes.push(
      "耐久性向上改修工事の住宅特定改修特別税額控除(税額控除)は多世帯同居改修工事の住宅特定改修特別税額控除適用後の所得税額からのみ差し引く(住民税に相当する控除は無い)。`/durability-improvement-renovation-deduction`の試算結果を前提とする。",
    );
    if (
      durabilityImprovementRenovationDeductionAppliedJpy.lessThan(
        durabilityImprovementRenovationDeductionJpy,
      )
    ) {
      notes.push(
        "耐久性向上改修工事の住宅特定改修特別税額控除額が控除適用後の所得税額を上回ったため、超過分は切り捨てて0円を下限とした(繰越・還付は生じない)。",
      );
    }
  }
  if (childRearingRenovationDeductionJpy.greaterThan(0)) {
    notes.push(
      "子育て対応改修工事の住宅特定改修特別税額控除(税額控除)は耐久性向上改修工事の住宅特定改修特別税額控除適用後の所得税額からのみ差し引く(住民税に相当する控除は無い)。`/child-rearing-renovation-deduction`の試算結果を前提とする。",
    );
    if (childRearingRenovationDeductionAppliedJpy.lessThan(childRearingRenovationDeductionJpy)) {
      notes.push(
        "子育て対応改修工事の住宅特定改修特別税額控除額が控除適用後の所得税額を上回ったため、超過分は切り捨てて0円を下限とした(繰越・還付は生じない)。",
      );
    }
  }
  if (certifiedHousingConstructionCreditJpy.greaterThan(0)) {
    notes.push(
      "認定住宅等新築等特別税額控除(税額控除)は子育て対応改修工事の住宅特定改修特別税額控除適用後の所得税額からのみ差し引く(住民税に相当する控除は無い)。`/certified-housing-construction-credit`の試算結果を前提とする。",
    );
    if (
  ...
  if (foreignTaxCreditNationalTaxCreditJpy.greaterThan(0) || foreignTaxCreditResidentTaxCreditJpy.greaterThan(0)) {
    notes.push(
      "外国税額控除(税額控除)は認定住宅等新築等特別税額控除適用後の所得税額・寄附金特別控除適用後の住民税額から差し引いており、所得税・復興特別所得税・住民税それぞれの控除限度額の判定は`/foreign-tax-credit`の試算結果を前提とする。",
    );
    if (
