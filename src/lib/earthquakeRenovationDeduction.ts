 ...
 *    行う前提とする。
 *  - バリアフリー改修・三世代同居改修・耐久性向上改修に対応する住宅特定改修
 *    特別税額控除(措置法41条の19の3)や、認定住宅新築等特別税額控除
 *    (投資型減税。措置法41条の19の4)は別制度のため対象外(今後の課題)。
 *    省エネ改修工事分は`energySavingRenovationDeduction.ts`で対応済み。
 */
